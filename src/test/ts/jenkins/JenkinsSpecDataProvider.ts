...
class JenkinsSpecDataProvider {
    ...
    public getJenkinsMonitorModel(): JenkinsMonitorModel {
        return <JenkinsMonitorModel>MonitorModels
            .createModel(JenkinsSpecDataProvider.MONITOR_JSON, this.configuration, JenkinsSpecDataProvider.HOST);
    }
    ...
    public getJenkinsMonitorViewModel(): JenkinsMonitorViewModel {
        return <JenkinsMonitorViewModel>MonitorModels
            .createViewModel(JenkinsSpecDataProvider.MONITOR_JSON, this.configuration, JenkinsSpecDataProvider.HOST);
    }
